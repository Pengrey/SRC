...
# Set interfaces
set interfaces ethernet eth0 address 300.4.4.40/24
set interfaces ethernet eth1 address 300.3.3.30/24  
set interfaces ethernet eth2 address 300.2.2.30/24
set interfaces ethernet eth3 address 300.1.1.40/24

# Static Routes
set protocols static route 10.2.2.10/24 next-hop 10.3.3.30
set protocols static route 10.2.2.10/24 next-hop 10.4.4.40
